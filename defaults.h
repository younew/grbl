...
#define defaults_h
  ...
  #define DEFAULT_RAPID_FEEDRATE 500.0//zzg //500.0 // mm/min  
  #define DEFAULT_FEEDRATE 250.0
  #define DEFAULT_ACCELERATION (100.0*60*60)//zzg//(10.0*60*60) // 10 mm/min^2
  #define DEFAULT_JUNCTION_DEVIATION 0.05 // mm
  #define DEFAULT_STEPPING_INVERT_MASK (( Y_DIRECTION_BIT)|( Z_DIRECTION_BIT))
  ...
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10
  #define DEFAULT_MM_PER_ARC_SEGMENT 0.1
  #define DEFAULT_RAPID_FEEDRATE 10000  //zzg//2500.0 // mm/min
  #define DEFAULT_FEEDRATE 10000  //zzg//1000.0 // mm/min
  #define DEFAULT_ACCELERATION 600.0*60*60 //150.0*60*60 // 150 mm/min^2
  #define DEFAULT_JUNCTION_DEVIATION 0.5//0.05 // mm
  ...
  #define DEFAULT_HOMING_DEBOUNCE_DELAY 100 // msec (0-65k)
  #define DEFAULT_HOMING_PULLOFF 1.0 // mm
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 25 // 0.5msec (0-255)
  #define DEFAULT_DECIMAL_PLACES 3
  #define DEFAULT_N_ARC_CORRECTION 25
#endif
